...
function initServertab(){$('*[data-toggle="tab"]').each(function(){$(this).click(function(){var a=$($(this).contents()[1]).text();localStorage.setItem("srvtab",a)})});var a=localStorage.getItem("srvtab");a&&$('*[data-toggle="tab"]').each(function(){$($(this).contents()[1]).text()==a&&$(this).click()})}function initPage(){initDrawH3list();initSoftscroll();initServerFilter();initTileProgress();initServertab();$("body").append('<div id="'+sDivPlotter+'" class="plotter"></div>')}
function showTab(a){mydiv=".subh2 ";$(mydiv+" > h3").hide();$(mydiv+" > .subh3").hide();$(mydiv+" > "+a).show();$(mydiv+" > "+a+" + div.subh3").show();$(mydiv+" li a").blur();return!1}var sDivPlotter="divPlotter",bPlotterSticky=!1;function stickyGraph(a,c,b){var d=bPlotterSticky;bPlotterSticky=!1;$("#"+sDivPlotter+" .btnclose").hide();showGraph(a,c,b);d||(bPlotterSticky=!0,$("#"+sDivPlotter+" .btnclose").show())}
...
b.data.length+"<br>",f+=aLang.statsCurrent?aLang.statsCurrent+": "+b.data[0][1]+"<br>":"",f+=aLang.statsMin?aLang.statsMin+": "+b.min+"<br>":"",f+=aLang.statsMax?aLang.statsMax+": "+b.max+"<br>":"",f+=aLang.statsAvg?aLang.statsAvg+": "+b.avg+"<br>":"");$("#"+a).html('<div class="infos">'+f+'</div><canvas id="'+q+'"></canvas>');a=document.getElementById(q).getContext("2d");new Chart(a,{type:"bar",data:{labels:r,datasets:[{type:"bar",label:p,data:JSON.parse("["+c+"]"),borderColor:"#80d0f4",backgroundColor:"#80d0f4",
fill:!0,lineTension:0,radius:0},{type:"line",label:h,data:JSON.parse("["+n+"]"),borderColor:"#aaaaaa",backgroundColor:"#eeeeee",borderWidth:1,borderDash:[3,1],fill:!0,radius:0},{type:"line",label:aLang.statsMax,data:JSON.parse("["+l+"]"),borderColor:"#ff0000",backgroundColor:"#ff0000",borderWidth:1,borderDash:[3,3],fill:!1,radius:0},{type:"line",label:aLang.statsAvg,data:JSON.parse("["+d+"]"),borderColor:"#e0a010",backgroundColor:"#e0a010",borderWidth:1,borderDash:[3,3],fill:!1,radius:0},{type:"line",
label:aLang.statsMin,data:JSON.parse("["+m+"]"),borderColor:"#008000",backgroundColor:"#008000",borderWidth:1,borderDash:[3,3],fill:!1,radius:0}]},options:{animation:{duration:0},scales:{x:{display:!1},y:{ticks:{beginAtZero:!0,max:g?g:b.max}}},plugins:{legend:{display:!1},title:{display:!1,text:p}}}});return!0}
function showGraph(a,c,b){if(bPlotterSticky)return!1;var d='<div class="btnclose" onclick="hideGraph(1);"> X </div><div class="title">'+b+'</div><div id="hovergraph" class="graph"></div>';$("#"+sDivPlotter).html(d).show();showGraphInline("hovergraph",a,c,50,b)||$("#"+sDivPlotter).hide()}function hideGraph(a){a&&(bPlotterSticky=!1);if(bPlotterSticky)return!1;$("#"+sDivPlotter).hide()}function twodigits(a){return 9<a?a:"0"+a};